...
public class MainActivity extends AppCompatActivity {
    ...
    private Button cancel, apiToMp4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiToMp4 = (Button) findViewById(R.id.api_to_mp4);
        ...
        apiToMp4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // String exe = "-i '" + downLoadPath + "/input.avi' -c:v libx264 -preset ultrafast -crf 51 " + downLoadPath + "/output_crf51.mp4";
                 String exe = "-hwaccel cuvid '" + downLoadPath + "/input.avi' -c:v h264_cuvid -preset veryfast " + downLoadPath + "/output_accel_.mp4";
